        ...
        <section ref={explainerRef} className="geo-explainer" id="what-is-geo">
          <div className="geo-explainer-grid">
            ...
            <div className="geo-explainer-text">
              ...
              <p>Online visibility has changed dramatically — traditional click-through rate from organic results has dropped by more than <strong>55% since 2022</strong>. Why? Because people now ask AI assistants instead of clicking search results. Businesses relying only on Google search rankings are losing clients without even realizing it.</p>
              <p>GEO (Generative Engine Optimization) is the evolution of search engine optimization (SEO) for the AI era. While SEO focuses on ranking factors like title tags, meta descriptions, mobile-friendly design, URLs, crawl optimization, and backlinks to improve search rankings in Google and other search engines — GEO ensures AI chatbots like ChatGPT, Claude, Perplexity, and Google Gemini recommend YOUR business when people ask for help.</p>
              <p>More people are now asking AI assistants &quot;Who&apos;s the best tax consultant in Brussels?&quot; or &quot;Recommend a web designer in Belgium&quot; instead of running a search query on Google. If your web page isn&apos;t optimized for AI indexing, you&apos;re invisible to this growing audience — even if your SEO ranking and organic traffic are strong.</p>
              <p>GEO is not just the future — it&apos;s happening NOW. Businesses that adapt early, with proper relevance, inbound links, and structured content that AI can index, will dominate their markets while competitors wonder where their clients went.</p>
            </div>
          </div>
        </section>
