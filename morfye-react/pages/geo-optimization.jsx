...
const faqs = [
  ...
  { question: 'How is GEO different from traditional SEO?', answer: 'Traditional SEO helps your web pages rank on search engine results pages (SERPs) like Google through keyword research, title tags, link building, backlinks, and technical optimizing. GEO targets AI assistants directly — ChatGPT, Gemini, Perplexity — which don\'t use the same search engine ranking signals. A good digital marketing strategy needs both: SEO for organic search clicks, GEO for AI recommendations. We combine both into one SEO strategy.' },
  { question: 'Does GEO help with local search and local SEO?', answer: 'Yes — local GEO is one of the most powerful tactics for local businesses. When searchers ask AI "best web designer near me" or "accountant in Brussels," you want to be the answer. We optimize your local search presence so AI engines know your niche, location, and services, just like local SEO does for Google search.' },
  { question: 'What is the role of content marketing in GEO?', answer: 'Content marketing is the backbone of GEO. AI engines are trained on text — so the more high-quality, relevant content your web pages have, the more AI understands and recommends you. We focus on creating content that answers the search queries your target audience asks, with natural language, clear structure, and proper meta markup that both search engines and AI engines can index.' },
  { question: 'Do you build backlinks and do link building for GEO?', answer: 'Yes — citation building and backlinks from authoritative websites are central to our GEO process. AI engines learn from the web, and if trustworthy sources (directories, industry websites, digital marketing publications) mention your business with proper anchor text, you become more credible to AI. This overlaps with traditional link building but targets AI-trusted domains specifically.' },
  { question: 'Will GEO replace my current SEO efforts?', answer: 'No. GEO complements SEO — you still need traditional SEO for Google rankings, PPC/AdWords for paid search, and content marketing for inbound traffic. GEO adds a new layer of visibility so that when AI assistants are asked about your niche or industry, your business is on the first page of their recommendations.' },
