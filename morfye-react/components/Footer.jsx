      ...
      <div className="footer-inner">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            <img src="/morfye-logo.webp" alt="Morfye web design agency logo" title="Morfye web design agency logo" className="footer-logo" width="500" height="500" loading="lazy" />
            ...
            <div className="footer-socials">
              ...
              <a href="https://www.instagram.com/morfye.be" target="_blank" rel="noopener noreferrer" aria-label="Instagram" title="Morfye on Instagram">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://www.facebook.com/morfye" target="_blank" rel="noopener noreferrer" aria-label="Facebook" title="Morfye on Facebook">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-contact-list">
              <li>
                ...
                <a href="mailto:info.morfye@gmail.com" title="Email Morfye web design agency">info.morfye@gmail.com</a>
              </li>
              <li>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <li>
                ...
                <a href="tel:+32000000000" title="Call Morfye web design agency">+32 479 96 01 13</a>
              </li>
            </ul>
          </div>
